...
let coins=parseInt(localStorage.getItem('coins')||0),usdt=parseFloat(localStorage.getItem('usdt')||50);
let gigaWatched=parseInt(localStorage.getItem('gigaWatched')||0),monetagWatched=parseInt(localStorage.getItem('monetagWatched')||0);
let totalAdsWatched=parseInt(localStorage.getItem('totalAdsWatched')||0),lastAdTime=parseInt(localStorage.getItem('lastAdTime')||0);
