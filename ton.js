let depositInputEl, withdrawInputEl;
...
function initTonConnect(){
    ...
    tonConnectUI.onStatusChange(wallet=>{
        if(wallet){userWalletAddress=wallet.account.address;walletConnected=true;localStorage.setItem('walletConnected','true');localStorage.setItem('walletAddress',userWalletAddress);showToast("TON Wallet Connected!",'success')}
